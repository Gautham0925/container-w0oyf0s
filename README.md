...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w0oyf0s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w0oyf0s.containers.anotherwebservice.com/
...
```
git clone git@github.com:Gautham0925/container-w0oyf0s.git
cd container-w0oyf0s
```
...
```
docker attach container-w0oyf0s
```
